  ...
  const onSubmit = data => {
    ...
    return (
        <div>
            ...
            <h2 className='lg:text-4xl text-md font-semibold text-center'>Best Food Waiting for your Belly</h2>
      ...
      >
      <input className='border border-black px-4 lg:w-72 w-52 rounded-full mr-2' placeholder='Search' {...register("search")} required/>
      {errors.exampleRequired && <span>This field is required</span>}
      <input className='cursor-pointer  lg:py-3 py-1 lg:mx-0 mx-8 bg-red-600 lg:w-28 w-32 lg:my-0 my-2 text-white font-medium normal-case rounded-full' type="submit" />
    </form>
            </div>
            </div>
            <div className='grid lg:grid-cols-3 px-14 gap-10 lg:py-4'>
                {
